...
The project combines Bayesian Networks, probabilistic inference, and Generative AI to generate personalized recipe recommendations and natural-language explanations.
